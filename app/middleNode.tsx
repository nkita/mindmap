...
import { Plus, Bold, Italic, Underline, Link as LinkIcon, Code, Palette, ExternalLink } from "lucide-react";
...
// メインコンポーネント
const LexicalEditor = ({ initialValue, initialState, onSave, onBlur, isEditing, editorRef, setEditorInstance }: LexicalEditorProps) => {
